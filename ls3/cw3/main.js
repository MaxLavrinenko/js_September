...
*/
    ...
    */
        ...
        //     document.write (`<div> 
        //     NAME- ${simpson.name} SURNAME-${simpson.surname} AGE-${simpson.age} INFO-${simpson.info} 
        ...
        // for (simpson of simpsons){
        //         document.write (`<div> 
        //         <h2> NAME- ${simpson.name} SURNAME-${simpson.surname} AGE-${simpson.age}</h2><br/>
        ...
        */
            ...
            for(product of products){
                ...
                <img src="${product.image}" alt="" calss="product-image">`)
            }
            document.write(`</div>`);